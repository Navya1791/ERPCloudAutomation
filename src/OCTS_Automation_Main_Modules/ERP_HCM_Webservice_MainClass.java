...
public class ERP_HCM_Webservice_MainClass extends ReporterBaseTest {
	...
	String encStr;
	 ...
	 ArrayList<Cell> cells_uPersonNumber;
	 String cellvalue_uPersonNumber;
	 ArrayList<Cell> cells_uFirstName;
	 String cellvalue_uFirstName;
	 ArrayList<Cell> cells_uLastName;
	 String cellvalue_uLastName;
	 ArrayList<Cell> cells_uAssignmentNumber;
	 String cellvalue_uAssignmentNumber;
	...
	@Parameters({ "testFile", "GIInterfaceFile" })
	 @Test	 
	public  void OracleCloud_Financial_Webservices(String inputEmpLoad_fp,String workerFile_fp) throws Exception {
		try{
		 ...
		 System.out.println(inputEmpLoad_fp);
		 System.out.println(workerFile_fp);
		/*
         * Code to read input data file 
         */
		 
		 test = extent.createTest("Testing Employee Load");
		 System.out.println("after create test");

           try {
				     file = new FileInputStream(
				     new File(inputEmpLoad_fp));
				  } 
           catch (Exception e1) {
       ...
       //    XSSFRow row = ips1.getRow(0);
           ...
           cells_uPersonNumber = cu.columnIdentification("UFTU_FileName",ips1);
           System.out.println(cells_uPersonNumber);
           cellvalue_uPersonNumber=cu.getCellFormattedStringValue(cells_uPersonNumber.get(currentRowNum),workbook);
           
           cells_uFirstName = cu.columnIdentification("UFTU_FileName",ips1);
           System.out.println(cells_uFirstName);
           cellvalue_uFirstName=cu.getCellFormattedStringValue(cells_uFirstName.get(currentRowNum),workbook);

           cells_uLastName = cu.columnIdentification("UFTU_FileName",ips1);
           System.out.println(cells_uLastName);
           cellvalue_uLastName=cu.getCellFormattedStringValue(cells_uLastName.get(currentRowNum),workbook);
           
           cells_uAssignmentNumber = cu.columnIdentification("UFTU_FileName",ips1);
           System.out.println(cells_uAssignmentNumber);
           cellvalue_uAssignmentNumber=cu.getCellFormattedStringValue(cells_uAssignmentNumber.get(currentRowNum),workbook);
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
           ...
           try{
           encStr=eudb.utilDecodeBase(workerFile_fp);
