...
public class FXMLController implements Initializable {
    ...
    public void selectFilePath1(ActionEvent event) {
        ...
        outputTextScreen.appendText("Select Input Data Excel Sheet: "+inputfile_fp+newLine);
    ...
    public void selectFilePath2(ActionEvent event) {
        ...
        outputTextScreen.appendText("Select Process Related Data File: "+GIfile_fp+newLine);
        fileButton2.setDisable(false); 
	...
	public Task createWorker() {
        return new Task() {
          ...
          protected Object call() throws Exception {
        	  ...
        	  String output = ws.iterateThroughTestCases(inputfile_fp, GIfile_fp,testModule);
